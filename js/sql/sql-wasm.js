  ...
  initSqlJsPromise = new Promise(function (resolveModule, reject) {
    ...
    k.onRuntimeInitialized = function () {
      ...
      function b(f, l) {
        for (var n = [], p = 0; p < f; p += 1) {
          ...
          if (1 === w || 2 === w) r = ic(r);
            ...
            r = kc(w);
            w = lc(w);
            for (var J = new Uint8Array(r), I = 0; I < r; I += 1)
              J[I] = m[w + I];
            r = J;
          } else r = null;
          n.push(r);
      ...
      var g = y(4),
        ...
        v = h("sqlite3_close_v2", "number", ["number"]),
        ...
        va = h("sqlite3_result_error", "", ["number", "string", "number"]),
        ...
        try {
          ...
          for (f = []; 0 !== t(J, "i8"); ) {
            ...
            if (0 !== L) {
              var G = null;
              r = new c(L, this);
              for (null != l && r.bind(l); r.step(); )
                (null === G &&
                  ((G = { columns: r.qb(), values: [] }), f.push(G)),
                  G.values.push(r.get(null, n)));
              r.Ya();
            }
          }
          return f;
      ...
      e.prototype.Jb = function (f, l) {
        ...
        var w = {};
        Object.hasOwnProperty.call(this.Sa, f) &&
          (A(this.Sa[f]), delete this.Sa[f]);
        l = f + "__finalize";
    ...
    var nb = {
      ...
      O = {
          ...
          P(c.mode)
            ...
            : 32768 === (c.mode & 61440)
              ...
              : 40960 === (c.mode & 61440)
                ...
                : 8192 === (c.mode & 61440) &&
                  ((c.La = O.Wa.yb.node), (c.Ma = O.Wa.yb.stream));
        ...
        La: {
          ...
          lookup() {
            O.nb ||
              ((O.nb = new N(44)), (O.nb.stack = "<generic error, no stack>"));
            throw O.nb;
          },
          ib(a, b, c, d) {
    ...
    function na(a, b, c = 438) {
      ...
      b & 512 &&
        !g &&
        ((e = d),
        (e = "string" == typeof e ? S(e, { ab: !0 }).node : e),
        ac(null, e, 0));
      b &= -131713;
      e = Rb({
        node: d,
    ...
    var da,
      ...
      Xc = {
        ...
        h: function (a) {
          try {
            var b = T(a);
            Tb(b, b.node, { timestamp: Date.now(), Lb: !1 });
            return 0;
          } catch (c) {
            if ("undefined" == typeof X || "ErrnoError" !== c.name) throw c;
            return -c.Pa;
        ...
        B: (a, b, c, d) => {
          ...
          b = b(e);
          e < g
            ? (M(a, C, c, 17), M(b, C, d, 17))
            : (M(a, C, d, 17), M(b, C, c, 17));
        },
        d: () => Date.now(),
        s: () => 2147483648,
        c: () => performance.now(),
