...
namespace Blazor_App.Shared
{
    public class CookieManager
    {
        ...
        public static void PushCookies(FrameWork frameWork, string serialized, string message)
        {
            ...
            CookUpServices.UpdateContentAsync(cookieInfo, message + "-" + frameWork.ToString() + "-" + DateTime.Now.ToString(), serialized);
        }
